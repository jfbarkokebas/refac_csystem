		...
		<div class="content-area">
			...
			<div class="doc-action-container">
				<div id="doc-container">
					<div id="contrato">
						...
						<img class="receipt-logo" width="60"
							src="${pageContext.request.contextPath}/assets/b_botazini-logo.png ">
					</div>
						<div class="section">
							<strong>Comprador:</strong>
							<br> 
							Nome:  <span >Botazini</span> CNPJ: <span >61.357.461/0001-00</span>
						</div>
						<div class="section">
						...
						<div class="section">
							...
							<form id="form-purchase-values" method="post" 
								...
								<input type="hidden" name="action" value="purchaseStock">
								...
								<strong id="unidade">${unit}:</strong>
								 <span id="quantidade">
									...
									name="amount-purchase" type="number" min="0" value="${amount}">
								</span>
								<div class="section">
									<strong>Data:</strong> 
									<input class="doc-input" id="purchaseDate"
											name="purchaseDate" type="datetime-local" >
								</div>
						...
						<div class="signature"  style="margin-top: 0.6rem;">
							<div> _________________________________
								<br> 
								<span id="compradorNomeAssinatura">Café e Pimenta Ltda</span>
							</div>
							<div> _________________________________
								<br> 
			...
			<div style="width: 23%">
				<div class="confirm-receipt">
					<p>
						Quantidade: <span id="confirm-quantity">${amount}</span> ${unit}
					</p>
					<p>
						Preço: R$ <span id="confirm-price"></span>
					</p>
					<p>
						Data: <span id="confirmDate"></span>
					</p>
					<div id="button-area" >
						<button class="btn-2" id="confirm-btn" style="background-color: #00ffe8a9">Confirmar</button>
					</div>
				</div>
				<c:if test="${not empty saleActive}">
					<div class="sale-info-box" style="background-color: #1a1454; color: #efefef">
						<p>
							Venda aberta de ${clientProduct}
						</p>
						<p>
							Quantidade pendente:  <span>${fmtPendency}</span> ${unit}
						</p>
						<p>
							Preço unidade:  R$ <span>${saleActive.pricePerUnitSold}</span>
						</p>
					</div>
				</c:if>
			</div>
